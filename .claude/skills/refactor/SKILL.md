---
description: Refactors a single file to meet our review criteria
disable-model-invocation: true
---
Refactor $0 to meet following review criteria.
...
Give me options on how to refactor $0 so that it meets my formatting objectives.